export default function AIDemo() {
  const messages = [
    ...
    { sender: "DishFuse AI", text: "Chicken Alfredo cost rose 12%. Suggest increasing menu price by $2 to recover margin." },
  ...
  return (
    <section className="w-full bg-[#0b1424] text-white py-16 flex flex-col items-center">
      ...
      <div className="bg-[#111b2d] rounded-2xl w-full max-w-3xl p-6 shadow-lg">
        {messages.map((m, i) => (
